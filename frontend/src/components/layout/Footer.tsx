  ...
  return (
    <footer className="bg-surface-dark text-white/80">
      ...
      <div className="overflow-hidden">
        ...
        >
          <path
            d="M0 48h1440V28C1200 8 960 48 720 28S240 8 0 28z"
            fill="#0c3217"
          />
        </svg>
      </div>
      ...
      <div className="mx-auto max-w-[82rem] px-5 pb-10 pt-2 md:px-8 lg:px-12">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-12">
          ...
          {/* Contact column */}
          <div>
            <h3 className="mb-5 text-label uppercase tracking-[0.15em] text-white/40">
              연락처
            </h3>
            <ul className="space-y-3.5 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="whitespace-pre-line text-white/70 leading-relaxed">
                  {FARM_INFO.hours}
                </span>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
              <p className="font-semibold text-white">농협 123-1234-1234-12</p>
            ...
            <div className="mt-4 inline-flex items-center gap-1.5 rounded-full border border-forest-700 bg-forest-900/50 px-3 py-1.5">
              ...
              <span className="text-[0.7rem] font-semibold text-forest-300">
                당일 수확 · 당일 발송
              </span>
            </div>
          </div>
